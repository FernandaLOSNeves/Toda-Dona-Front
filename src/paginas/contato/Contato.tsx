  ...
  return (
    <>
      ...
      <Grid xs={12} className='redir'>
        <h3>Quer saber mais informações sobre nós? mande um email para <a href="mailto:todainformada@gmail.com">todainformada@gmail.com</a></h3>
      </Grid>
      <Grid xs={12} className='redir'>
        <h3>Gostaria de ser uma investidora? escreva para: <a href="mailto:todadonainvestidores@gmail.com">todadonainvestidores@gmail.com</a></h3>
      </Grid>
      <Grid xs={12} className='redir2'>
        <h3>Quer vender conosco? <a href="/cadastro">Cadastre-se</a> ou faça <a href="/login">login</a> para continuar.</h3>
      </Grid>
    </>
  )
}
